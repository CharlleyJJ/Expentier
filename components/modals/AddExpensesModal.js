...
const {expenses, addExpenseItem, addCategory} = values;
...
{/*Expenses Categories*/}
        {expenseAmount > 0 && (
            ...
            onClick={() => {
                ...
                }} className="flex items-center justify-between px-4 py-3  bg-gradient-to-tr  from-gray-700 via-gray-900 to-black rounded-3xl  hover:border transition hover:border-slate-700  duration-700 ease-in-out hover:scale-105 ">
